...
const NEW_ANNOUNCEMENT = `
    INSERT INTO announcements(img, title_uz, body_uz, title_ru, body_ru, title_en, body_en, date, sort) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
`
...
const newAnnouncement = (img, title_uz, body_uz, title_ru, body_ru, title_en, body_en, date, sort) => fetchAll(NEW_ANNOUNCEMENT, img, title_uz, body_uz, title_ru, body_ru, title_en, body_en, date, sort)
