...
`
const NEW_NEWS = `
    INSERT INTO news(img, title_uz, body_uz, title_ru, body_ru, title_en, body_en, date, sort) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
`
...
const newNews = (img, title_uz, body_uz, title_ru, body_ru, title_en, body_en, date, sort) => fetchAll(NEW_NEWS, img, title_uz, body_uz, title_ru, body_ru, title_en, body_en, date, sort)
